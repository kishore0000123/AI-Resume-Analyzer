...
export default function PreviewResume() {
  ...
  const draft = useMemo(
    () => location.state?.draft || getSavedBuilderDraft(),
    [location.state]
  );

  const [selectedTemplate, setSelectedTemplate] = useState(
    draft?.selectedTemplate || "minimal"
  );
      ...
      <main style={{ minHeight: "80vh", display: "grid", placeItems: "center" }}>
        <div className="card" style={{ maxWidth: 560, textAlign: "center" }}>
          ...
          <p style={{ color: "var(--text-secondary)" }}>
            Start from Generate page and create your resume draft first.
          </p>
          <button
      ...
      <div className="container" style={{ maxWidth: 1000 }}>
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <StepIndicator
            ...
            steps={["Fill Details", "Preview Resume", "Download"]}
          />
              ...
              style={{
                ...
                border:
                  feedback.type === "error"
                    ...
                    : "1px solid rgba(34,211,164,0.35)",
                background:
                  feedback.type === "error"
                    ? "rgba(244,63,94,0.1)"
                    : "rgba(34,211,164,0.1)",
